...
mixin _$GetUserState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(UsersEntity users) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(UsersEntity users)? success,
...
class _$_Success implements _Success {
  const _$_Success({required this.users});
  ...
  @override
  String toString() {
    return 'GetUserState.success(users: $users)';
  }
...
abstract class _Success implements GetUserState {
  const factory _Success({required final UsersEntity users}) = _$_Success;
